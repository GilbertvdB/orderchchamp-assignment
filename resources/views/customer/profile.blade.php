        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <ul>
                    ...
                    <li><strong>Address Number:</strong> {{ $customer->address_nr }}</li>
                    <li><strong>Postal Code:</strong> {{ $customer->postalcode }}</li>
                    <li><strong>City:</strong> {{ $customer->city }}</li>
                    <li><strong>Country:</strong> {{ $customer->country->name }}</li> <!-- Assuming you have a relationship set up -->
                </ul>
            </div>
            <div class="col-md-6">
                ...
                <form action="{{ route('customer.update') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="address_nr" id="address_nr" class="form-control" value="{{ $customer->address_nr }}">
                    </div>
                    <div class="form-group">
                        <label for="postalcode">Postal Code</label>
                        <input type="text" name="postalcode" id="postalcode" class="form-control" value="{{ $customer->postalcode }}">
                    </div>
                    <div class="form-group">
                        <label for="city">City</label>
                        <input type="text" name="city" id="city" class="form-control" value="{{ $customer->city }}">
                    </div>
                    <!-- Country field here, assuming you have a select dropdown for countries -->
